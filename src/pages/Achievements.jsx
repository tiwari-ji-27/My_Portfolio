  ...
  return (
    <section className="px-6 md:px-16 py-12 md:py-20 relative overflow-hidden">
      ...
      <motion.h2
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="text-3xl md:text-5xl font-extrabold mb-10 md:mb-14 text-center bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent"
      >
        Achievements & Coding Journey
      </motion.h2>
      ...
      <div className="max-w-6xl mx-auto mb-16 md:mb-20">
        <div className="flex items-center justify-center gap-3 md:gap-4 mb-8">
          <ShieldCheck className="text-purple-400" size={24} md:size={28} />
          <h3 className="text-xl md:text-2xl font-semibold text-white">LeetCode Performance</h3>
        </div>
        ...
        <motion.div
          ...
          className="mx-auto mb-10 w-fit p-6 rounded-2xl border border-gray-700 bg-gray-900/60 shadow-2xl text-center"
        >
          <img src="/knight.png" alt="Knight Badge" className="w-32 md:w-40 mx-auto" />
          <p className="mt-3 bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent font-bold">
            Knight Badge • 1859 Rating
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {["leetcode-streak.png", "leetcode-rating.png"].map((img, i) => (
            <motion.div
              key={i}
              whileHover={{ scale: 1.02 }}
              className="p-4 md:p-6 rounded-2xl border border-gray-800 bg-black/40"
            >
              <img src={`/${img}`} alt="LeetCode Visual" className="rounded-lg w-full h-auto mx-auto shadow-lg" />
            </motion.div>
          ))}
        </div>
      </div>
      ...
      {/* ================= STATS ================= */}
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto mb-16 md:mb-20">
        {stats.map((stat, index) => (
          <div key={index} className="p-4 md:p-6 rounded-2xl border border-gray-800 bg-gray-900/40 text-center">
            <div className="mx-auto mb-2 text-purple-400 flex justify-center">{stat.icon}</div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14 items-start">
        {/* Left: Coding Profiles */}
        <div>
          <h3 className="text-2xl md:text-3xl font-bold text-white mb-6 md:mb-8">Coding Profiles</h3>
          <div className="space-y-4">
            {profiles.map((item, index) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center justify-between px-6 py-4 rounded-xl bg-gray-800/40 border border-gray-700 hover:border-purple-500 transition shadow-md"
              >
        ...
        {/* Right: Achievements */}
        <div>
          <h3 className="text-2xl md:text-3xl font-bold text-yellow-400 mb-6 md:mb-8">Top Competitive Achievements</h3>
          <div className="space-y-4 md:space-y-6">
            {achievements.map((item, index) => (
              <div key={index} className="relative p-5 md:p-6 rounded-2xl bg-gray-800/40 border border-gray-700 shadow-lg">
                <div className="absolute left-0 top-0 h-full w-1.5 bg-yellow-400 rounded-l-2xl"></div>
                <div className="pl-4">
                  <div className="text-xl md:text-2xl font-bold text-yellow-400">{item.value}</div>
                  <div className="text-base md:text-lg font-semibold text-white">{item.title}</div>
                  <div className="text-xs md:text-sm text-gray-400 mt-1">{item.desc}</div>
                </div>
              </div>
            ))}
          </div>
